...
from account_types 
inner join accounts on accounts.id = accounts.type;

create view accounts_and_types_accounts as 
select accounts.account_no, account_types.id, account_types.name 
from account_types 
inner join accounts on accounts.id = accounts.type;
------------------------------------------------------------------------------
...
from transactions 
left join transactions_types on transactions.id = transactions.account_des; 

create view transactions_made as 
select transactions.id, transactions.amount, transactions_types.name  
from transactions 
left join transactions_types on transactions.id = transactions.account_des;
-------------------------------------------------------------------------------